...
import ChildrenContact from "./childrenContact";
        ...
        <div className="i va bb ye ki xn wq jb mo">
          <div className="tc uf sn tf rn un zf xl:gap-10">
            <div className="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
              ...
              />
              <ChildrenContact label={"email"} content={email} />
              <ChildrenContact label={"Address"} content={address} />
              <ChildrenContact label={"Phone Number"} content={phone} />
              <ChildrenContact label={"Github"} content={github} />
              ...
              <div>
                ...
                <ul className="tc wf fg">
                  <li>
                    <a href={facebook} className="c tc wf xf ie ld rg ml il tl">
                      <svg
                  ...
                  <li>
                    <a href={tweeter} className="c tc wf xf ie ld rg ml il tl">
                      <svg
                        className="th lm ml il"
                        width="20"
                        height="16"
                  ...
                  <li>
                    <a href={linkidn} className="c tc wf xf ie ld rg ml il tl">
                      <svg
                        className="th lm ml il"
                        width="19"
                        height="18"
