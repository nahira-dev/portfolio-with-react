...
import "../../../index.css";
import logoNahira from "../../../assets/nahira-hitam.png";
          ...
          <div className="vd wo/4 sd qo f ho oo wf yf">
            <nav>
              <ul className="tc _o sf yo cg ep">
                <li>
                  <a className="xl">Home</a>
                </li>
                <li>
                  <a href="#my-skill" className="xl">
                    Ability
                  </a>
                </li>
                <li>
                  <a href="#gallery" className="xl">
                    Gallery
                  </a>
                </li>
                <li>
                  <a href="#myContact" className="xl">
                    Contact
                  </a>
                </li>
              </ul>
            ...
            <div className="tc wf ig pb no">
              ...
              <Link to="/login" className="lk gh dk rg tc wf xf _l gi hi">
                Sign In
              </Link>
            </div>
          </div>
